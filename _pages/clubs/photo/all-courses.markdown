...
<style>
/* Add your CSS styles here if needed for specific formatting */
body {
  font-family: Arial, sans-serif;
}

.full-width-content-item ul {
  list-style-type: disc;
}

.full-width-content-item ul ul {
...
- **Intro to Digital Photography** (2015)
  - Session 1: Basics & Exposure (Bob Peters, [slides (pptx)](https://drive.google.com/uc?export=download&id=1Nh6pU21uckXjcjcFWskYTB87zQdUxD_H)) <!-- Using ICC Color Profiles link as placeholder -->
  - Session 2: Metering, White Balance & Gadgets (Karen Smale, [slides (pptx)](https://drive.google.com/uc?export=download&id=1BHveboFSwJqwD_fue9xdQKghSy8jpNXn)) <!-- Using Light Painting link as placeholder -->
  - Sessions 3-4: Settings & Mechanics (Scott Hull, [slides (pptx)](https://drive.google.com/uc?export=download&id=1ZOGUak1jV91wDAOgEDBEXoMkq5XLsyG2)) <!-- Using Basic Astrophotography link as placeholder -->
  - Sessions 5-6: Composition (Nancy Rosenbaum [slides (pptx)](https://drive.google.com/uc?export=download&id=1IROX7EAyGRBVqSBqZBDuE6MWxLEvI3k6)) <!-- Using Photo Orbs link as placeholder -->

- **Intro to Digital Photography** (2013)
  - Camera Mechanics (Scott Hull, [PPTX](https://drive.google.com/uc?export=download&id=1KDKbPOBpO_jayYPN02xbk6TRhT98BEUZ)) <!-- Using Electronic Viewfinders link as placeholder -->
  - Composition (Nancy Rosenbaum, [PPTX](https://drive.google.com/uc?export=download&id=1MiOrAhCw-fy5ihCqO2JCkTFjgUEPWGlz)) <!-- Using Layers link as placeholder -->

- **Intro to Digital Photography** (2012)
